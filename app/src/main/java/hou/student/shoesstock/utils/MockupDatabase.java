...
public class MockupDatabase {
    ...
    public static List<Product> getAllProducts() {
        ...
        products.add(new Product("San pham", "100000", R.drawable.anhshoescard3, "Adidas"));
        products.add(new Product("San pham", "100000", R.drawable.anhshoescard2, "Bata"));
        products.add(new Product("San pham", "100000", R.drawable.anhshoescard2, "Puma"));
        ...
        products.add(new Product("San puma", "100000", R.drawable.anhshoescard2, "Puma"));
        products.add(new Product("San puma", "100000", R.drawable.anhshoescard2, "Puma"));
        products.add(new Product("San puma", "100000", R.drawable.anhshoescard2, "Puma"));
        products.add(new Product("San pham", "100000", R.drawable.anhshoescard2, "Nike"));
        return products;
